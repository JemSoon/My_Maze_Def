...
public class MAX_AD : MonoBehaviour
{
    private const string MaxSdkKey = "kEMm9P5L89OR0kvrUxOrTTVN9dqKyRhNPrdPnpPGfIfE4VF8qn99egv-sLgnKP8oEBmF9yAWGW1eTOBAvr-qo_";
    ...
    private const string RewardedAdUnitId = "83c03740375ffaae";
    ...
    System.Action<bool> OnResult = null;
    public void ShowRewardedAd(System.Action<bool> onResult)
    {
        OnResult = onResult;
